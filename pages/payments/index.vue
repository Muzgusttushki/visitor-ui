  ...
  <el-container class="payments index">
    <el-main v-loading="loading.pages">
      <div class="wallpaper-table">
        <div class="tools">
          <div>
            <h3>Транзакции <span v-if="this.payments">({{this.payments.length}})</span></h3>
          </div>
          ...
          <el-table :data="this.payments.data" class="payments-list" @row-click="paymentDetails">
            ...
            >
              <template slot-scope="scope">
                ...
                <span
                  v-else-if="column.source == 'firstActive' || column.source == 'lastActive'"
            ...
            this.$nextTick(async () => {
                ...
                if (reset) {
                  ...
                  this.localFilters = {
                      ...
                      averageMoney: [this.filters.minAverageEarnings, this.filters.maxAverageEarnings],
                      ticketInTransaction: [this.filters.minTickets, this.filters.maxTickets],
                      transactions: [this.filters.minTransactions, this.filters.maxTransactions],
                      city: [],
                      event: [],
                      offset: 0
                  }
